...
def createShops():
        try:
            connection = mysql.connector.connect(
                host='localhost', database='PriceComparisonTool1', user='root', password='admin')
